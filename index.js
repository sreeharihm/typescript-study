...
function askQuestion(q) {
    ...
    const userAnswer = readline_sync_1.default.question("Your answer (number): ");
...
function main() {
    ...
    while (true) {
        ...
        console.log("3. Exit");
        const choice = readline_sync_1.default.question("Enter choice: ");
        if (choice === "1") {
            const topic = readline_sync_1.default.question("Enter topic (class, generic, interface, union, enum, mappedType, decorator, async): ");
